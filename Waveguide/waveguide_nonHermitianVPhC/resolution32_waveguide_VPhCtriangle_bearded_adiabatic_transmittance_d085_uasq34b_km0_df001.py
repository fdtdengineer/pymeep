...
if __name__ == "__main__":  
    ...
    a = 470
    c_const = 299792458
    freqs_wo, psd_out_wo = phc_trans(PhC = False, lengthPhC = 20, decay_check=10, T_decay=1500, name_time=name_dt)
    freqs_w,  psd_out_w  = phc_trans(PhC = True, lengthPhC = 50, decay_check=20, T_decay=1e5, name_time=name_dt)
